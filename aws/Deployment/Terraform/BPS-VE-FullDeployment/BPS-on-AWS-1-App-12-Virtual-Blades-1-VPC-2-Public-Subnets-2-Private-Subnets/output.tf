	...
	value = {
		...
		name => {
			ami = {
				...
				name = module.Ami.name
				owner_id = module.Ami.owner_id
			}
			availability_zone = module.Instance.availability_zone
			eth0 = {
				eip = {
					public_dns = module.Eth0ElasticIp.public_dns
					public_ip = module.Eth0ElasticIp.public_ip
				}
			}
			...
			instance_type = {
				...
				name = module.Instance.instance_type
			...
			private_dns = module.Instance.private_dns
