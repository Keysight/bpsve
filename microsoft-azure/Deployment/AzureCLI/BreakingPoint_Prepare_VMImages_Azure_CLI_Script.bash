...
if [ -z $1 ]; then
    ...
    echo "ex: ./BreakingPoint_Prepare_VMImages_Azure_CLI_Script.bash Ixia_Images_RG bpsvhds930update1"
    exit 1
fi
...
#source
source_bps_virtual_controller_blob=Ixia_BreakingPoint_Virtual_Controller_9.30.117_KVM.vhd
source_bps_virtual_blade_blob=Ixia_BreakingPoint_Virtual_Blade_9.30.117_KVM.vhd
source_bps_virtual_controller_account_name=bpsve930update1
source_bps_virtual_controller_container=bps-container
source_bps_virtual_blade_container=bps-container 
source_bps_virtual_controller_account_key=DqLfkH7NIBdB6jtHrlKPp28AhR4psT7VRhlA5fKRtkUg8KBrPWxOcbDEtj0ykatrJZdwRpij4jNO+AStMXPcfw==

#destination
destination_resource_group_name=$1
destination_account_name=$2
destination_container_name=bpsvevhd930update1
destination_bps_virtual_controller_blob=Ixia_BreakingPoint_Virtual_Controller_9.30_Update1.vhd
destination_bps_virtual_blade_blob=Ixia_BreakingPoint_Virtual_Blade_9.30_Update1.vhd
