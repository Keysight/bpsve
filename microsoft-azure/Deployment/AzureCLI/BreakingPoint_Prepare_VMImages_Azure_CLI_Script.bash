...
if [ -z $1 ]; then
    ...
    echo "ex: ./BreakingPoint_Prepare_VMImages_Azure_CLI_Script.bash Ixia_Images_RG bpsvhds922"
    exit 1
fi
...
#source
source_bps_virtual_controller_blob=Ixia_BreakingPoint_Virtual_Controller_9.22.116_KVM.vhd
source_bps_virtual_blade_blob=Ixia_BreakingPoint_Virtual_Blade_9.22.116_KVM.vhd
source_bps_virtual_controller_account_name=bpsve922
source_bps_virtual_controller_container=bps-container
source_bps_virtual_blade_container=bps-container 
source_bps_virtual_controller_account_key=k235NHVq0tHvsUm6Sz9rGM2iY3EKBM+V7zzN5Xy+WW+3kW6FT8Wop6XgJWpT0h0KwVMlEa0G5YRr+AStTpggWw==

#destination
destination_resource_group_name=$1
destination_account_name=$2
destination_container_name=bpsvevhd922
destination_bps_virtual_controller_blob=Ixia_BreakingPoint_Virtual_Controller_9.22.vhd
destination_bps_virtual_blade_blob=Ixia_BreakingPoint_Virtual_Blade_9.22.vhd
