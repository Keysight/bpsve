...
if [ -z $1 ]; then
    ...
    echo "ex: ./BreakingPoint_Prepare_VMImages_Azure_CLI_Script.bash Ixia_Images_RG bpsvhds930"
    exit 1
fi
...
source_bps_virtual_controller_account_name=bpsve930
source_bps_virtual_controller_container=bps-container
source_bps_virtual_blade_container=bps-container 
source_bps_virtual_controller_account_key=cNhoZIYKgXK9EdR/mMhfxe6PHV5YqxXCMtzDLGgwNhoGdOGFTPdNjX0DjxsA5G/xMui9Yx+z/A2Y+AStC+COmw==

#destination
destination_resource_group_name=$1
destination_account_name=$2
destination_container_name=bpsvevhd930
destination_bps_virtual_controller_blob=Ixia_BreakingPoint_Virtual_Controller_9.30.vhd
destination_bps_virtual_blade_blob=Ixia_BreakingPoint_Virtual_Blade_9.30.vhd
